...
//custom input field to prevent repitive occurence of input field
export default function InputField({children,name,text,error,placeholder,type="text",className,value,onChange,onBlur}:IFieldButton) {
  return (
